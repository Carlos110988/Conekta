	...
	public static function errorHandler($resp, $code) {
		...
		if (isset($code) != true || $code == 0) {
			throw new Conekta_NoConnectionError(
				ConektaLANG::translate('error.requestor.connection', array('BASE'=>Conekta::$apiBase), ConektaLANG::EN),
				ConektaLANG::translate('error.requestor.connection_purchaser', null, Conekta::$locale),
				$type, $code, $params);
		}
		switch ($code) {
			case 400:
